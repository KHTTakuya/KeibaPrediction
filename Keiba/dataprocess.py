...
class DataProcess:
    ...
    def fathermon_data_process(self, index='fathermon'):
        ...
        df_score = df_score.rename(
            columns={0: 'fathermon_pca1', 1: 'fathermon_pca2', 2: 'fathermon_pca3', 3: 'fathermon_pca4',
        ...
        cols = ['fathermon_pca1', 'fathermon_pca2', 'fathermon_pca3', 'fathermon_pca4', 'fathermon_pca5',
                'fathermon_pca6',
                'fathermon_pca7', 'fathermon_pca8', 'fathermon_pca9', 'fathermon_pca10', 'fathermon_pca11',
                'fathermon_pca12',
    ...
    def pre_race_data_process(dataframe):
        ...
        name_days_df = df[["horsename", "place", "turf", "distance", "days", "pop", "odds",
                           "rank3", "rank4", "3ftime", "result", 'speedindex', 'last_race_index', 'count',
                           'rentai']].sort_values(['horsename', 'days'])
        ...
        df_sh_before = df_sh_before.rename(
            columns={'place': 'pre_place', 'turf': 'pre_turf', 'distance': 'pre_distance',
